...
class Toast extends StatefulWidget {
  Toast({
    ...
    this.toastPosition = PositionToast.top,
  ...
  ///}
  ///```
  final PositionToast toastPosition;
        ...
        pageBuilder: (context, _, __) => GestureDetector(
          ...
          child: SafeArea(
            child: AlertDialog(
              ...
              elevation: 0,
              content: Column(
                mainAxisAlignment: toastPosition == PositionToast.bottom ? MainAxisAlignment.end : MainAxisAlignment.start,
                children: [
                  SizedBox(
                    child: this,
                  ),
...
class _ToastState extends State<Toast> with TickerProviderStateMixin {
  ...
  Widget _renderLeftLayoutToast(BuildContext context) {
    return Column(
      mainAxisAlignment: widget.toastPosition == PositionToast.top ? MainAxisAlignment.start : MainAxisAlignment.end,
      children: [
        SlideTransition(
    ...
    return Expanded(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: widget.layout == ToastLayout.ltr ? CrossAxisAlignment.start : CrossAxisAlignment.end,
          children: [
